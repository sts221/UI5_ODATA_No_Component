				...
				"ui5_odata.InitialView",
				{
					...
					onInit : function() {
						...
						var oModel = new sap.ui.model.odata.v2.ODataModel(
								...
								// "http://sapdev.rcmp-grc.gc.ca:8007/sap/opu/odata/sap/ZSNS_USERS_CRUD_SRV"); // when used from the ABAP WAS
                    ...
                    openDeleteDialog: function(ctx) {
                        ...
                        oDeleteDialog.addButton( 
                               new sap.ui.commons.Button({
                                     text: "Confirm", 
                                     press:function(){ sap.ui.getCore().getModel().remove(ctx, {
                                            	       success: function() {
